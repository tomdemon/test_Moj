...
public class ProszeOKomentarz {

    private final int numberOfClasses;
    private final int numberOfNotes;
    private int[][] notes;

    public ProszeOKomentarz(int numberOfClasses, int numberOfNotes) {
    ...
    public static void main(String[] args) {
        ...
        int numberOfNotes = 4;
        ProszeOKomentarz proszeOKomentarz = new ProszeOKomentarz(numberOfClasses, numberOfNotes);
        proszeOKomentarz.getNotesFromUser();
        proszeOKomentarz.printAverate();
    }
